                                    ...
                                    element.lBooks.map((el, id) => {
                                        ...
                                        return (
                                            <Card style={{ width: '18rem', height: 'fit-content' }} className="mar-style" key={ind} >
                                                ...
                                                <Card.Body>
                                                    <Card.Title>Book's Name: {el.lbook} </Card.Title>
                                                    <Card.Title>Time period on lend(in days): {el.ltime} </Card.Title>
                                                    <div onClick ={() => { borrow(el, id)}}>Borrow</div>
                                                </Card.Body>
                                            </Card>
                                        );
                                    })
